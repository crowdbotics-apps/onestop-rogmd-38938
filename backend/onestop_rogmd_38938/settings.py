"""
Django settings for onestop_rogmd_38938 project.
...
ROOT_URLCONF = 'onestop_rogmd_38938.urls'
...
WSGI_APPLICATION = 'onestop_rogmd_38938.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "onestop_rogmd_38938 API",
    "DESCRIPTION": "API documentation for onestop_rogmd_38938 App",
    "VERSION": "v1",
}
